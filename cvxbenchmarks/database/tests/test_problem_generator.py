...
from cvxbenchmarks.database.problem_generator import ProblemTemplate
...
@patch('cvxbenchmarks.database.problem_generator.Environment.get_template')
@patch('cvxbenchmarks.database.problem_generator.pd.read_csv')
